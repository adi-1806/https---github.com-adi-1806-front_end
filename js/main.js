...
boxes.forEach(box => {
    let display = true
    const boxButton = box.querySelector(".box-button");
    const boxButtonIcon = box.querySelector("img");
    const innerBox = box.querySelector(".inner-box");
    boxButton.addEventListener("click", () => {
        innerBox.style.display = display? "none" : "block";
        boxButtonIcon.src = display? "img/plus.png": "img/minus.png"
        display = !display
    })
})
